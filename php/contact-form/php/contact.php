...
if ( $session_verify != $posted_verify ) {
    ...
    if ( !empty($error) ) {
        echo '<div class="form-message">Wrong verifcation code.';
        echo '</div>';
...
$msg .= "You can contact $name via e-mail, $email." . PHP_EOL;
$msg .= "-------------------------------------------------------------------------------------------" . PHP_EOL;
...
if ( mail( $address, $e_subject, $msg, $headers ) ) {
	...
	echo "<div class='form-message'>Thank you $name, your message has been submitted to us.</div>";
	echo "</div>";
	echo "</fieldset>";
